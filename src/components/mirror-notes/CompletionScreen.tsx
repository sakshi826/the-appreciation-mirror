  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3 w-full max-w-xs">
        <Button variant="mirror" size="lg" onClick={onSave} className="w-full py-6">
        ...
        <Button
          ...
          size="lg"
          onClick={onAddMore}
          className="w-full py-6 rounded-full border-primary/30 text-foreground"
        >
